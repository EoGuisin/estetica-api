...
<td style="text-align: right;">${this.formatCurrency(item.procedureValue)}</td>
...
<td style="text-align: right;">${this.formatCurrency(item.paidAmount)}</td>
...
<p style="color: #D97706;">${this.formatCurrency(summary.totalPending)}</p>
...
<p style="color: #059669;">${this.formatCurrency(summary.totalPaid)}</p>
...
<td style="text-align: right;">${this.formatCurrency(item.amountDue)}</td>
...
<p style="color: #3B82F6;">${this.formatCurrency(summary.totalPending)}</p>
...
<p style="color: #D97706;">${this.formatCurrency(summary.totalOverdue)}</p>
...
<p style="color: #059669;">${this.formatCurrency(summary.totalValue)}</p>
...
<td style="text-align: right; font-weight: bold;">${item.daysInactive} dias</td>
...
<p style="color: #059669;">${this.formatCurrency(summary.totalRevenue)}</p>
...
<p style="color: #DC2626;">${this.formatCurrency(summary.totalExpense)}</p>
